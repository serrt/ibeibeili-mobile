const routes = [
  ...
  // 邀请有奖
  { path: '/user-invite', name: 'user-invite', component: (resolve) => { require(['./views/UserInvite.vue'], (resolve)) }, meta: { requiresAuth: true } },
  { path: '/user-invite-friend', name: 'user-invite-friend', component: (resolve) => { require(['./views/UserInviteFriends.vue'], (resolve)) }, meta: { requiresAuth: true } },
  // 新浪用户中心
  ...
  { path: '/activity2', name: 'activity2', component: (resolve) => { require(['./views/activity2.vue'], (resolve)) } },
  // 404
